...
curl -fsSL -H 'Cache-Control: no-cache' \
  https://auth.jiefakj.com/static/dist/admin/AdminInterface-2026.8.0.js \
...
targeted Vitest files plus `pnpm --dir web run lint:types`; add broader lint/build checks when
